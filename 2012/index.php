...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            var username = "zhongjiacong@gmail.com";
            ...
            function showStartBtn() {
            	//alert("show start");
            	$("#btndiv").html('<button class="btn btn-success" id="start_conference">Start Translation</button>');
            }
            
            function showEndBtn() {
            	//alert("show end");
            	$("#btndiv").html('<button class="btn btn-danger" id="end_conference">End Translation</button>');
            }
            ...
            function getContact() {
                $.ajax({
                    url: "imuyun.com/friend/contacts/",
                    type: "POST",
                    cache: false,
                    dataType: "json",
                    data: {},
