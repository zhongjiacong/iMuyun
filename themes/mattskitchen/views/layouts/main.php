...
<div class="container" id="wrapper">
	...
	<header id="header">
	    <div id="logo"><?php echo CHtml::link(CHtml::encode(Yii::t('layouts',Yii::app()->name)), '/'); ?></div>
	
		<nav id="mainmenu">
			<?php
				$menuItems = array(
					array('label'=>'Home', 'url'=>array('/site/index')),
					array('label'=>'User', 'url'=>array('/user/index')), //zjc
	...
	<footer id="footer">
	    <nav id="footermenu">
			<?php
				...
				echo CHtml::link('中文',array('','lang'=>'zh_cn')).' | '.CHtml::link('English',array('','lang'=>'en_us'));
			?>
	    </nav>
	    <div class="content">
